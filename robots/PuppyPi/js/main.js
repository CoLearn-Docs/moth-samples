...
async function sendCommandToDevice(keyPressDirection) {
  ...
  const controlObject =
    keyPressDirection === "Stand" ||
    keyPressDirection === "liedown" ||
    keyPressDirection === "lookdown"
      ? { pose: keyPressDirection }
      : keyPressDirection === "N" ||
        keyPressDirection === "S" ||
        keyPressDirection === "CW" ||
        keyPressDirection === "CCW" ||
        keyPressDirection === "STOP"
      ? { direction: keyPressDirection }
      : { action: keyPressDirection };
