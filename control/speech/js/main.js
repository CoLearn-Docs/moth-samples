...
const speechDialect = document.getElementById("speechDialect");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  speechLanguage.addEventListener("change", selectedLanguage);
  selectedLanguage();
});
...
function selectedLanguage() {
  ...
  var list = langs[speechLanguage.selectedIndex];
...
function sendCommand() {
  ...
  recognition.addEventListener("result", (event) => {
    ...
    if (controlWebsocket) {
      sendCommandToDevice(SpeechCommandMap[transcript]);
    }
  ...
  recognition.addEventListener("error", (event) => {
    console.error(">> speech ai error:", event.error);
  });
...
const sendCommandToDevice = (command) => {
